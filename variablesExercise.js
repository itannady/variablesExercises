...
// The difference between the rules for num1 and num2 is that num2 is inclusive of 1 and 10, whereas num1 is not. 
...
const myAnswerForExercise11 = "numbers";
...
//It was fairly easy. I had to use Google for exercise 15 because I wasn't sure if combining a string with numbers would give out an "NaN" or if it would concatenate. 
